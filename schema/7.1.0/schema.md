...
<table><tbody>
    ...
    <tr>
      ...
      <td>
       ...
       If <code>organism_ontology_term_id</code> is a descendant of <a href="https://www.ebi.ac.uk/ols4/ontologies/ncbitaxon/classes?obo_id=NCBITaxon%3A7399"><code>NCBITaxon:7399</code></a> for <i>Hymenoptera</i>, this MAY instead be the most accurate descendant of <a href="https://www.ebi.ac.uk/ols4/ontologies/hao/classes?obo_id=HAO%3A0000000"><code>HAO:0000000</code></a> for <i>anatomical entity</i>. <code>HAO:</code> is not merged into any Uberon multi-species product, so such a term satisfies this field by virtue of this clause rather than by a Uberon cross-reference.<br/><br/>
    ...
    <tr>
      ...
      <td>
        ...
        Otherwise, this MUST be the most accurate descendant of <a href="https://www.ebi.ac.uk/ols4/ontologies/uberon/terms?obo_id=UBERON%3A0000105"><code>UBERON:0000105</code></a> for <i>life cycle stage</i> (or any term from an imported ontology cross-referenced to it, e.g., <a href="https://www.ebi.ac.uk/ols4/ontologies/hsapdv/terms?obo_id=HsapDv%3A0000001"><code>HsapDv:0000001</code></a> for <i>life cycle</i> in <a href="https://www.ebi.ac.uk/ols4/ontologies/ncbitaxon/classes?obo_id=NCBITaxon%3A9606"><code>NCBITaxon:9606</code></a> for <i>Homo sapiens</i>).<br/><br/>
          ...
          The following organism-specific ontologies are recognized. For Metazoa their terms are valid in addition to UBERON; for <i>Viridiplantae</i>, <code>PO:</code> replaces UBERON entirely, as stated above:
          <table><tbody>
            <tr>
              <th>Organism</th>
    ...
    <tr>
      <th>Value</th>
        <td>
          ...
          If <code>organism_ontology_term_id</code> is <a href="https://www.ebi.ac.uk/ols4/ontologies/ncbitaxon/classes?obo_id=NCBITaxon%3A33090"><code>NCBITaxon:33090</code></a> for <i>Viridiplantae</i> or one of its descendants, or a descendant of <a href="https://www.ebi.ac.uk/ols4/ontologies/ncbitaxon/classes?obo_id=NCBITaxon%3A6040"><code>NCBITaxon:6040</code></a> for <i>Porifera</i> or <a href="https://www.ebi.ac.uk/ols4/ontologies/ncbitaxon/classes?obo_id=NCBITaxon%3A10197"><code>NCBITaxon:10197</code></a> for <i>Ctenophora</i>, a female/male distinction is frequently not applicable to the sampled organism. This MUST then be one of <a href="https://www.ebi.ac.uk/ols4/ontologies/pato/classes?obo_id=PATO%3A0000383"><code>"PATO:0000383"</code></a> for <i>female</i>, <a href="https://www.ebi.ac.uk/ols4/ontologies/pato/classes?obo_id=PATO%3A0000384"><code>"PATO:0000384"</code></a> for <i>male</i>, <a href="https://www.ebi.ac.uk/ols4/ontologies/pato/classes?obo_id=PATO%3A0001340"><code>"PATO:0001340"</code></a> for <i>hermaphrodite</i>, or <code>"na"</code>. Use <code>"PATO:0001340"</code> for a monoecious plant or a simultaneous hermaphrodite, <code>"na"</code> where the organism has no applicable sex phenotype, and <code>"PATO:0000383"</code> or <code>"PATO:0000384"</code> only for a dioecious plant or a gonochoric individual whose sex was determined. <code>"unknown"</code> MUST NOT be used to mean "not applicable"; it is reserved for a sex that exists but was not recorded.<br/><br/>
...
<table><tbody>
    ...
    <tr>
      ...
      <td>
        If <code>tissue_type</code> is <code>"cell line"</code>, this MUST be <code>"na"</code><br/><br/>
        If <code>organism_ontology_term_id</code> is NOT <code>"NCBITaxon:9606"</code> for <i>Homo sapiens</i>, this MUST be <code>"na"</code>.<br/><br/>
        Otherwise, if <code>organism_ontology_term_id</code> is <code>"NCBITaxon:9606"</code> for <i>Homo sapiens</i>, this MUST be <code>"unknown"</code> if unavailable; otherwise, this MUST meet the following requirements:
        <ul>
          <li>
    ...
    <tr>
      <th>Value</th>
        <td>
          ...
          MONDO does not cover plant disease. If <code>organism_ontology_term_id</code> is <a href="https://www.ebi.ac.uk/ols4/ontologies/ncbitaxon/classes?obo_id=NCBITaxon%3A33090"><code>NCBITaxon:33090</code></a> for <i>Viridiplantae</i> or one of its descendants, this MUST instead be <a href="https://www.ebi.ac.uk/ols4/ontologies/pato/classes?obo_id=PATO%3A0000461"><code>"PATO:0000461"</code></a> for <i>normal</i> or <i>healthy</i>, or one or more descendants of <code>"PSO:0000001"</code> for <i>plant stress</i> in ascending lexical order separated by <code>" || "</code> with no duplication of terms. Both branches of PSO are permitted: the biotic stress branch covers pathogen- and pest-induced disease, and the abiotic stress branch covers environmental damage. <code>MONDO:</code> MUST NOT be used for Viridiplantae, and <code>PSO:</code> MUST NOT be used outside it. Where the study concerns a resistance or susceptibility trait rather than an observed disease state, it is STRONGLY RECOMMENDED to also record the matching descendant of <code>"TO:0000387"</code> for <i>plant trait</i> as an author-defined column in <code>obs</code>. <code>TO:</code> terms are documentation only and are not validated by this schema. See <a href="#appendix-b-relevant-ontologies">Appendix B</a>.
        </td>
    </tr>
</tbody></table>
...
<table><tbody>
    ...
    <tr>
      <th>Value</th>
      <td>
        Please refer to <a href="#appendix-b-relevant-ontologies">Appendix B</a> for relevant experimental condition ontologies according to your species.<br/><br/>
        ...
        <ul>
          ...
          <li>
            <a href="https://www.ebi.ac.uk/ols4/ontologies/chebi/classes/http%253A%252F%252Fpurl.obolibrary.org%252Fobo%252FCHEBI_50906?lang=en"><code>"CHEBI:50906"</code></a> for <i>role</i> and its descendants
          </li>
        </ul>
...
| Viridiplantae | *Viridiplantae* | `NCBITaxon:33090` | `TO:` | plant trait (author-defined `obs` column, not validated) | `TO:0000387` | **standalone** |
